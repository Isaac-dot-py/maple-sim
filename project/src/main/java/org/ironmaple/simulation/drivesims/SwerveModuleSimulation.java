...
public class SwerveModuleSimulation {
    ...
    public Vec2 updateSimulationSubTickGetModuleForce(
            Vec2 moduleCurrentGroundVelocityWorldRelative, Rotation2d robotFacing, double gravityForceOnModuleNewtons) {
    ...
    private Vec2 getPropellingForce(
        ...
        // Create force vector from magnitude and angle
        return new Vec2(
                (float) (propellingForceNewtons * Math.cos(moduleWorldFacing.getRadians())),
                (float) (propellingForceNewtons * Math.sin(moduleWorldFacing.getRadians())));
    }
