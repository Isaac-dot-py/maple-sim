...
public class CrescendoNoteOnField extends GamePieceOnFieldSimulation {
    ...
    private static CircleShape createNoteShape() {
        CircleShape shape = new CircleShape();
        shape.m_radius = (float) (Units.inchesToMeters(14) / 2);
        return shape;
    }

    public static final GamePieceInfo CRESCENDO_NOTE_INFO =
            new GamePieceInfo("Note", createNoteShape(), Inches.of(2), Kilograms.of(0.2), 3.5, 5, 0.3);
