...
public class RebuiltFuelOnField extends GamePieceOnFieldSimulation {
    private static CircleShape createFuelShape() {
        CircleShape shape = new CircleShape();
        shape.m_radius = (float) Centimeters.of(7.5).in(Meters);
        return shape;
    }

    public static final GamePieceInfo REBUILT_FUEL_INFO =
            new GamePieceInfo("Fuel", createFuelShape(), Centimeter.of(15), Pounds.of(0.5), 1.8, 5, 0.8);
